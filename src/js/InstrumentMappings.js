...
export function getInstrumentMappingTemplate(movement = 'physics') {
    if (Store.view.rotateOrigin === true) {
        return {
            sphereChordA0: {
                ballDesc: 'A',
                ...
                chord: ['A0', 'C1', 'E1'],
                type: 'chord',
                originalPosition: { x: 0, y: 0, z: 21 } //low
            },
            sphereChordB0: {
                ballDesc: 'B',
                ...
                chord: ['B0', 'D1', 'F1'],
                type: 'chord',
                originalPosition: { x: 0, y: 0, z: 20 } //low
            },
            sphereChordC1: {
                ballDesc: 'C',
                color: '#0018F9', //I - blue
                ...
                chord: ['C1', 'E1', 'A1'],
                type: 'chord',
                originalPosition: { x: 0, y: 0, z: 19 } //low
            },
            sphereChordD1: {
                ballDesc: 'D',
